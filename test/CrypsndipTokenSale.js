...
contract('CrypsndipTokenSale', function (accounts) {
    var tokenInstance;
    ...
    it('initializes the contract with the correct values', function() {
        return CrypsndipTokenSale.deployed().then(function(instance) {
    ...
    it('facilitates token buying', function() {
        return CrypsndipToken.deployed().then(function(instance) {
            ...
            return CrypsndipTokenSale.deployed();
            ...
            // Try to buy tokens different from the either value
    ...
    it('ends token sale', function() {
        return CrypsndipToken.deployed().then(function(instance) {
            ...
            assert.equal(balance.toNumber(), 999990, 'returns all unsold crypsndip tokens to admin');
